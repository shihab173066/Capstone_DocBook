...
<!--    ------css link---------->
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/profile2.css')); ?>">
              ...
              <div class="doctors">
                ...
                <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <div class="doc_info">
                     ...
                     <div class="details">
                        <span><b><?php echo e($d->fname); ?> <?php echo e($d->lname); ?></b></span>
                        <span><b>Speciality:</b> <?php echo e($d->speciality); ?></span>
                        ...
                        <span><b> Hospital: </b><?php echo e($d->hospital); ?> </span>
                        <span> <b>Email:</b> <?php echo e($d->email); ?></span>
                   ...
                   <div class="buttons">
                    <a href="view_doctors/<?php echo e($d->id); ?>" class="btn btn-primary">View Profile</a>
                   </div>
...
-->
<?php /**PATH C:\xampp\htdocs\docbook - final2\resources\views/view_doc_profile.blade.php ENDPATH**/ ?>