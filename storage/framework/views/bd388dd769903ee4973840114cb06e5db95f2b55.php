...
<div class="container-fluid p-0">
  ...
  <option value="3">Three</option>
            ...
            <span style="font-size: 20pt; font-weight: bold;">Patient Picture: </span><a href="#"><img width='100px' height='80px' src="/<?php echo e($x->propic); ?>" alt="profile pic"></a><br/>
            
                    <span style="font-size: 20pt; font-weight: bold;"> Patient ID: <?php echo e($x->userid); ?></span><br/>
                        
                        <span style="font-size: 20pt; font-weight: bold;"> Patient Email: <?php echo e($x->email); ?></span><br/>
                        <span style="font-size: 20pt; font-weight: bold;"> Patient Full Name: <?php echo e($x->fname); ?> <?php echo e($x->lname); ?></span><br/>
                        <span style="font-size: 20pt; font-weight: bold;"> Patient Age: <?php echo e($x->age); ?></span><br/>
                        <span style="font-size: 20pt; font-weight: bold;"> Patient Gender: <?php echo e($x->gender); ?></span><br/>
                        <span style="font-size: 20pt; font-weight: bold;"> Patient Phone: <?php echo e($x->phone); ?></span><br/>
                        <span style="font-size: 20pt; font-weight: bold;"> Patient BloodGroup: <?php echo e($x->bloodgroup); ?></span><br/>
              ...
              <div class="container">
                ...
                <a href="#"><img width='800px' height='600px' src="/<?php echo e($im->image); ?>" alt="image pic"></a><br/>
...
<?php endif; ?>
</html><?php /**PATH C:\xampp\htdocs\docbook\resources\views/prescription.blade.php ENDPATH**/ ?>