...
<div class="container-fluid p-0">
    <div class="logo_sec">
        <a href="window.location='<?php echo e(url("/")); ?>'" > 
  ...
  <button onclick="window.location='<?php echo e(url("/login")); ?>'" class="btn btn-primary" type="button">Join</button>
</div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\docbook\resources\views/welcome.blade.php ENDPATH**/ ?>